...
@section('main')
    <div class="container my-3">
        ...
        <p>В базе знаний ClassMotion перечислены возможные проблемы и пути их решения. Пожалуйста,
            ознакомьтесь с содержимым этой веб-страницы, прежде чем обращаться в службу технической поддержки.</p>
        <p>Если у Вас
            есть предложения/замечания по поводу работы программы, сообщения об ошибках, и прочая другая
            информация - просьба заполнить форму по ссылке. <a href="/report">Оставить отзыв или предложение
                разработчикам </a>
        </p>
