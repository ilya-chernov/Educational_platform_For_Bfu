...
<div class="col-lg-6 mx-auto p-3 py-md-5">
    <main>
        ...
        <p class="fs-5 col-lg-9">Здесь собраны все самые нужные и актуальные материалы (ссылки, файлы, расписание и т. п.) для учебы. По всем вопросам обращайтесь к старосте или администратору системы.</p>
       ...
       // </div> -->
        ...
        <div class="row g-5">
            <div class="col-md-6">
                ...
                <p>Полезные ресурсы, пригодные для обучения, уточнения материала, подготовки к контрольным и самостоятельным работам. </p>
                <ul class="icon-list">
                    <li><a href="http://mathprofi.ru/" target="_blank"> mathprofi.ru – Высшая математика – просто и доступно!</a></li>
                </ul>
            </div>

            <div class="col-md-6">
                <h2>Быстрые ссылки</h2>
                <p>Здесь собраны все ссылки информационного оснащения БФУ им. И. Канта. Пожалуйста, выберите интересующий Вас пункт</p>
                <ul class="icon-list">
